...
function nodeParent(rack) {
    ...
    if (rack.device_progress.FAIL) return t("Failing");
    ...
    if (
        rack.device_progress.VALID &&
        !rack.device_progress.PASS &&
        !rack.device_progress.UNKNOWN
    )
        return t("Validated");
...
function nodeValue(rack) {
    ...
    if (rack.device_progress.FAIL) return -1;
