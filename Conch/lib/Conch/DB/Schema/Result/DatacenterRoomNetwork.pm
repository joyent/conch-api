use utf8;
package Conch::DB::Schema::Result::DatacenterRoomNetwork;
...
Conch::DB::Schema::Result::DatacenterRoomNetwork
...
Related object: L<Conch::DB::Schema::Result::DatacenterNetwork>

=cut

__PACKAGE__->belongs_to(
  "network",
  "Conch::DB::Schema::Result::DatacenterNetwork",
  { id => "network_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bFH7aMEDopu7qaksu9XZkg
