use utf8;
package Conch::DB::Schema::Result::ValidationResult;
...
Related object: L<Conch::DB::Schema::Result::ValidationStateMember>

=cut

__PACKAGE__->has_many(
  "validation_state_members",
  "Conch::DB::Schema::Result::ValidationStateMember",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:puiSbi21xO7yx8ib1/mnYw
