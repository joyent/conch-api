...
Related object: L<Conch::Legacy::Schema::Result::DeviceNeighbor>
...
Related object: L<Conch::Legacy::Schema::Result::DeviceNicState>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:i26pvlx+ZUpOJ6IIGjBdyA
