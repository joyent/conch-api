...
Related object: L<Conch::Legacy::Schema::Result::DeviceValidateCriteria>
...
Related object: L<Conch::Legacy::Schema::Result::HardwareProfileSetting>
...
Related object: L<Conch::Legacy::Schema::Result::ZpoolProfile>

=cut

__PACKAGE__->belongs_to(
  "zpool",
  "Conch::Legacy::Schema::Result::ZpoolProfile",
  { id => "zpool_id" },
  {
    is_deferrable => 0,
    join_type     => "LEFT",
