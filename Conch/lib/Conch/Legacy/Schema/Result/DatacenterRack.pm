use utf8;
package Conch::Legacy::Schema::Result::DatacenterRack;
...
Related object: L<Conch::Legacy::Schema::Result::DatacenterRackRole>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zdUUE7p8vbmZabSZxM70kQ
