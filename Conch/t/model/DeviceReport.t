...
new_ok('Mojo::Conch::Model::DeviceReport');

my $device_report_model = Mojo::Conch::Model::DeviceReport->new(
    pg => $pg,
    log => qobj()
  );

subtest 'add reboot count' => sub {
  Mojo::Conch::Model::DeviceReport::_add_reboot_count($pg->db, $device_id);
