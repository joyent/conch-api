...
my $fields = q{
	  ...
	  hw_profile.sas_hdd_num AS hw_profile_sas_hdd_num,
	  hw_profile.sas_hdd_size AS hw_profile_sas_hdd_size,
	  hw_profile.sas_hdd_slots AS hw_profile_sas_hdd_slots,
	  hw_profile.sas_ssd_num AS hw_profile_sas_ssd_num,
	  hw_profile.sas_ssd_size AS hw_profile_sas_ssd_size,
	  hw_profile.sas_ssd_slots AS hw_profile_sas_ssd_slots,
	  hw_profile.sata_hdd_num AS hw_profile_sata_hdd_num,
	  hw_profile.sata_hdd_size AS hw_profile_sata_hdd_size,
	  hw_profile.sata_hdd_slots AS hw_profile_sata_hdd_slots,
	  hw_profile.sata_ssd_num AS hw_profile_sata_ssd_num,
	  hw_profile.sata_ssd_size AS hw_profile_sata_ssd_size,
	  hw_profile.sata_ssd_slots AS hw_profile_sata_ssd_slots,
	  hw_profile.nvme_ssd_num AS hw_profile_nvme_ssd_num,
	  hw_profile.nvme_ssd_size AS hw_profile_nvme_ssd_size,
	  hw_profile.nvme_ssd_slots AS hw_profile_nvme_ssd_slots,
	  hw_profile.raid_lun_num AS hw_profile_raid_lun_num,
...
sub _build_hardware_product ($hw) {
	...
	my $hw_profile = Conch::Class::HardwareProductProfile->new(
		...
		sas_hdd_num    => $hw->{hw_profile_sas_hdd_num},
		sas_hdd_size   => $hw->{hw_profile_sas_hdd_size},
		sas_hdd_slots  => $hw->{hw_profile_sas_hdd_slots},
		sas_ssd_num    => $hw->{hw_profile_sas_ssd_num},
		sas_ssd_size   => $hw->{hw_profile_sas_ssd_size},
		sas_ssd_slots  => $hw->{hw_profile_sas_ssd_slots},
		sata_hdd_num   => $hw->{hw_profile_sata_hdd_num},
		sata_hdd_size  => $hw->{hw_profile_sata_hdd_size},
		sata_hdd_slots => $hw->{hw_profile_sata_hdd_slots},
		sata_ssd_num   => $hw->{hw_profile_sata_ssd_num},
		sata_ssd_size  => $hw->{hw_profile_sata_ssd_size},
		sata_ssd_slots => $hw->{hw_profile_sata_ssd_slots},
		nvme_ssd_num   => $hw->{hw_profile_nvme_ssd_num},
		nvme_ssd_size  => $hw->{hw_profile_nvme_ssd_size},
		nvme_ssd_slots => $hw->{hw_profile_nvme_ssd_slots},
		raid_lun_num   => $hw->{hw_profile_raid_lun_num},
