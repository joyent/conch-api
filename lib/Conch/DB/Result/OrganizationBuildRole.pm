use utf8;
package Conch::DB::Result::OrganizationBuildRole;
...
=head1 TABLE: C<organization_build_role>

=cut

__PACKAGE__->table("organization_build_role");
...
__PACKAGE__->set_primary_key("organization_id", "build_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:F82fsrehFEzaBpnFTSm1Wg
