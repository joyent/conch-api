use utf8;
package Conch::DB::Schema::Result::HardwareProduct;
...
Related object: L<Conch::DB::Schema::Result::HardwareVendor>

=cut

__PACKAGE__->belongs_to(
  "vendor",
  "Conch::DB::Schema::Result::HardwareVendor",
  { id => "vendor" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kggDSwivv6g1Y4Mlhn+7eQ
