use utf8;
package Conch::DB::Schema::Result::UserAccount;
...
Related object: L<Conch::DB::Schema::Result::UserRelayConnection>

=cut

__PACKAGE__->has_many(
  "user_relay_connections",
  "Conch::DB::Schema::Result::UserRelayConnection",
...
Related object: L<Conch::DB::Schema::Result::UserSessionToken>
...
Related object: L<Conch::DB::Schema::Result::UserSetting>

=cut

__PACKAGE__->has_many(
  "user_settings",
  "Conch::DB::Schema::Result::UserSetting",
  { "foreign.user_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ebq0dcfmIx/8dhE5K8U8TA
