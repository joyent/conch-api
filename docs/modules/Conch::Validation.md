...
[Conch::Validation](/conch/modules/Conch::Validation) provides the base class to define and execute Conch
...
["test\_validation" in Test::Conch::Validation](/conch/modules/Test::Conch::Validation#test_validation) with TAP-based tests. This
...
[Conch::DB::Result::Device](/conch/modules/Conch::DB::Result::Device) object under validation.  Use in validation
...
[Conch::DB::Result::DeviceLocation](/conch/modules/Conch::DB::Result::DeviceLocation) object for the device being validated.
...
The expected [Conch::DB::Result::HardwareProduct](/conch/modules/Conch::DB::Result::HardwareProduct) object for the device being validated.
...
It is a [Conch::DB::Result::HardwareProductProfile](/conch/modules/Conch::DB::Result::HardwareProductProfile) object.
...
This method must be re-defined in sub-classes of [Conch::Validation](/conch/modules/Conch::Validation) or it will
raise an exception.
