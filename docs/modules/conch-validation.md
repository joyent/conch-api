...
[Conch::Validation](https://metacpan.org/pod/Conch::Validation) provides the base class to define and execute Conch
...
["test\_validation" in Test::Conch::Validation](https://metacpan.org/pod/Test::Conch::Validation#test_validation) with TAP-based tests. This
...
[Conch::DB::Result::Device](https://metacpan.org/pod/Conch::DB::Result::Device) object under validation.  Use in validation
...
[Conch::DB::Result::DeviceLocation](https://metacpan.org/pod/Conch::DB::Result::DeviceLocation) object for the device being validated.
...
The expected [Conch::DB::Result::HardwareProduct](https://metacpan.org/pod/Conch::DB::Result::HardwareProduct) object for the device being validated.
...
It is a [Conch::DB::Result::HardwareProductProfile](https://metacpan.org/pod/Conch::DB::Result::HardwareProductProfile) object.
...
This method must be re-defined in sub-classes of [Conch::Validation](https://metacpan.org/pod/Conch::Validation) or it will
raise an exception.
