...
See ["generate\_set" in Test::Conch::Fixtures](https://metacpan.org/pod/Test::Conch::Fixtures#generate_set) for available sets.
...
See ["\_generate\_definition" in Test::Conch::Fixtures](https://metacpan.org/pod/Test::Conch::Fixtures#generate_definition) for the list of recognized types.
