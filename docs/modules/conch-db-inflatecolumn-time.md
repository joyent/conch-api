...
is a subclass of [Time::Moment](https://metacpan.org/pod/Time::Moment)).
...
[Time::Moment](https://metacpan.org/pod/Time::Moment) object into Conch::Time, and work around the bug in
