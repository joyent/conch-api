...
Provides access to the fixtures defined in [Test::Conch::Fixtures](/conch/modules/Test::Conch::Fixtures).
...
Mirrors functionality in ["initialize\_db" in Conch::DB::Util](/conch/modules/Conch::DB::Util#initialize_db).
...
Returns the [Conch::DB](/conch/modules/Conch::DB) object as well when called in list context.
...
See ["generate\_set" in Test::Conch::Fixtures](/conch/modules/Test::Conch::Fixtures#generate_set) for available sets.
...
See ["\_generate\_definition" in Test::Conch::Fixtures](/conch/modules/Test::Conch::Fixtures#generate_definition) for the list of recognized types.
