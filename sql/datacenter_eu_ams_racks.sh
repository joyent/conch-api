...
DC_ROOM_ID=$( $PSQL -q -t -A -c "SELECT id FROM datacenter_room WHERE az = 'eu-central-1a'");
...
for RACK in 0303 0304 0305 0306 0307 0308 0309 0310 0311 0312 0313 0316 0408 0412 \
  ...
  $PSQL -c "$INSERT_SQL VALUES ('$DC_ROOM_ID', '$RACK', 45)"
done

DC_ROOM_ID=$( $PSQL -q -t -A -c "SELECT id FROM datacenter_room WHERE az = 'eu-central-1b'");
...
DC_ROOM_ID=$( $PSQL -q -t -A -c "SELECT id FROM datacenter_room WHERE az = 'eu-central-1c'");
